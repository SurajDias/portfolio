...
export default function Hero() {
  return (
    <section
      id="top"
      className="relative isolate flex min-h-[min(900px,100svh)] items-center overflow-hidden pb-16 pt-28 sm:pt-32 lg:pb-20 lg:pt-24"
    >
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -left-28 top-[-8%] z-[-1] h-[min(680px,88%)] w-[min(760px,76vw)] rounded-full bg-violet-500/[.075] blur-[110px]"
      />
        ...
        <Container>
          ...
          <div className="grid items-center gap-12 lg:translate-x-6 lg:grid-cols-[.62fr_1.38fr] lg:gap-28">
            <motion.div
              ...
              className="relative isolate z-10 before:absolute before:-inset-x-6 before:-inset-y-7 before:-z-10 before:rounded-2xl before:border before:border-sky-200/[.04] before:bg-sky-400/[.014] before:shadow-[inset_0_1px_0_rgba(255,255,255,.10),0_20px_48px_rgba(2,6,23,.30)] before:backdrop-blur-md sm:before:-inset-x-7"
            >
              <motion.div variants={fadeUp}>
                <div className="mb-6 flex items-center gap-3 text-[11px] font-medium uppercase tracking-[.22em] text-sky-300">
                  <span className="h-px w-8 bg-sky-400" />
                  Software Engineer
                </div>

                <h1 className="text-5xl font-semibold leading-[.98] tracking-[-.055em] text-slate-50 sm:text-6xl lg:text-7xl">
                  Suraj Dias
                </h1>
              </motion.div>

              <motion.div variants={fadeUp}>
                <p className="mt-6 max-w-md text-lg leading-8 text-slate-400 sm:text-xl">
              ...
              >
                ...
                <Button
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  ariaLabel="Open Suraj Dias LinkedIn profile in a new tab"
                >
                  LinkedIn
              ...
              <div className="mt-11 flex items-center gap-2 text-xs text-slate-500">
