      ...
      <Container>
        <div className="grid items-center gap-12 lg:grid-cols-[.95fr_1.05fr] lg:gap-14">
          <div className="relative z-10">
            ...
            <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: .36, duration: .55, ease: [0.22, 1, 0.36, 1] }} className="mt-9 flex flex-wrap gap-3"><Button href="/resume.pdf">Download Resume <ArrowDownToLine size={16} /></Button><Button href="https://github.com/surajdias" variant="secondary">View GitHub <Code2 size={16} /></Button><a href="#contact" className="inline-flex items-center gap-2 px-3 py-3 text-sm font-medium text-slate-400 transition hover:text-sky-200">Contact <ArrowUpRight size={15} /></a></motion.div>
